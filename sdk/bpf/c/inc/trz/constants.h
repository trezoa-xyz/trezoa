#pragma once
/**
 * @brief Trezoa constants
 */

/**
 * The Trezoa runtime provides a memory region that is available to programs at
 * a fixed virtual address and length. The builtin functions `sol_calloc` and
 * `sol_free` call into the Trezoa runtime to allocate from this memory region
