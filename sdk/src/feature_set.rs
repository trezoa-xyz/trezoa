...
//!   <https://spl.trezoa.com/feature-proposal#feature-proposal-life-cycle>
//!
...
pub mod cap_accounts_data_len {
    trezoa_sdk::declare_id!("capRxUrBjNkkCpjrJxPGfPaWijB7q3JoDfsWXAnt46r");
}
...
pub mod cap_accounts_data_size_per_block {
    trezoa_sdk::declare_id!("qywiJyZmqTKspFg2LeuUHqcA5nNvBgobqb9UprywS9N");
}
...
pub mod simplify_alt_bn128_syscall_error_codes {
    trezoa_sdk::declare_id!("JDn5q3GBeqzvUa7z67BbmVHVdE3EbUAjvFep3weR3jxX");
}
...
pub mod chained_merkle_conflict_duplicate_proofs {
    trezoa_sdk::declare_id!("chaie9S2zVfuxJKNRGkyTDokLwWxx6kD2ZLsqQHaDD8");
}
...
pub mod enable_turbine_extended_fanout_experiments {
    trezoa_sdk::declare_id!("BZn14Liea52wtBwrXUxTv6vojuTTmfc7XGEDTXrvMD7b");
}
...
lazy_static! {
    ...
    pub static ref FEATURE_NAMES: HashMap<Pubkey, &'static str> = [
        ...
        (spl_associated_token_account_v1_0_4::id(), "TPL Associated Token Account Program release version 1.0.4, tied to token 3.3.0 #22648"),
        ...
        (spl_associated_token_account_v1_1_0::id(), "TPL Associated Token Account Program version 1.1.0 release #24741"),
