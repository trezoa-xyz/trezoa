...
//!
//! [np2]: https://docs.trezoa.com/runtime/programs
//!
...
//!   - Invokable by programs? yes
//!
//! [lut]: https://docs.trezoa.com/proposals/versioned-transactions
...
///
/// [np]: https://docs.trezoa.com/runtime/programs#config-program
pub mod config {
    pub mod program {
