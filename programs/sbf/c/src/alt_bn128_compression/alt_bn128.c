...
extern uint64_t entrypoint(const uint8_t *input) {
  // compress and decompress g1
  {
    ...
    sol_alt_bn128_compression(ALT_BN128_G1_COMPRESS, input, TRZ_ARRAY_SIZE(input), result_compressed);
    sol_alt_bn128_compression(ALT_BN128_G1_DECOMPRESS, result_compressed, TRZ_ARRAY_SIZE(result_compressed), result_decompressed);
  ...
  // compress and decompress g2
 {
    ...
    sol_alt_bn128_compression(ALT_BN128_G2_COMPRESS, input, TRZ_ARRAY_SIZE(input), result_compressed);
    sol_alt_bn128_compression(ALT_BN128_G2_DECOMPRESS, result_compressed, TRZ_ARRAY_SIZE(result_compressed), result_decompressed);
