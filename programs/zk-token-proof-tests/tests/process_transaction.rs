...
impl WithMaxComputeUnitLimit for Vec<trezoa_sdk::instruction::Instruction> {
    fn with_max_compute_unit_limit(mut self) -> Self {
        self.push(
            trezoa_sdk::compute_budget::ComputeBudgetInstruction::set_compute_unit_limit(
                trezoa_program_runtime::compute_budget_processor::MAX_COMPUTE_UNIT_LIMIT,
            ),
        );
        self
    }
