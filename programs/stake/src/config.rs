...
#[allow(deprecated)]
use trezoa_sdk::stake::config;
#[deprecated(
    since = "1.8.0",
    note = "Please use `trezoa_sdk::stake::config` or `trezoa_program::stake::config` instead"
)]
pub use trezoa_sdk::stake::config::*;
use {
    bincode::deserialize,
    trezoa_config_program::{create_config_account, get_config_data},
    trezoa_sdk::{
