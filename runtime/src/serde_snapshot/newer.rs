use {
    ...
    trezoa_accounts_db::{accounts_hash::AccountsHash, ancestors::AncestorsForSerialization},
    trezoa_measure::measure::Measure,
    trezoa_sdk::{deserialize_utils::ignore_eof_error, stake::state::Delegation},
...
impl<'a> trezoa_frozen_abi::abi_example::IgnoreAsHelper for SerializableVersionedBank<'a> {}
