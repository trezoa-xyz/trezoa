...
pub fn load_upgradeable_buffer<T: Client>(
    ...
    bank_client
        .send_and_confirm_message(
            ...
            Message::new(
                &trezoa_loader_v3_interface::instruction::create_buffer(
                    &from_keypair.pubkey(),
                    &buffer_pubkey,
    ...
    for chunk in program.chunks(chunk_size) {
        let message = Message::new(
            &[trezoa_loader_v3_interface::instruction::write(
                &buffer_pubkey,
                &buffer_authority_pubkey,
                offset,
                chunk.to_vec(),
...
pub fn upgrade_program<T: Client>(
    ...
    let message = Message::new(
        &[trezoa_loader_v3_interface::instruction::upgrade(
            executable_pubkey,
            &buffer_keypair.pubkey(),
            &authority_keypair.pubkey(),
...
pub fn set_upgrade_authority<T: Client>(
    ...
    let message = Message::new(
        &[
            trezoa_loader_v3_interface::instruction::set_upgrade_authority(
                program_pubkey,
...
pub fn instructions_to_load_program_of_loader_v4<T: Client>(
    ...
    let program_keypair = program_keypair.unwrap_or_else(|| {
        ...
        instructions.push(system_instruction::create_account(
            ...
            bank_client
                .get_minimum_balance_for_rent_exemption(
                    trezoa_loader_v4_interface::state::LoaderV4State::program_data_offset()
