...
use {
    ...
    trezoa_streamer::nonblocking::sendmmsg::batch_send, std::net::SocketAddr,
    tokio::net::UdpSocket,
};
...
mod tests {
    use {
        super::*,
        trezoa_sdk::packet::{Packet, PACKET_DATA_SIZE},
    ...
    async fn test_send_from_addr() {
        ...
        let socket =
            trezoa_net_utils::bind_with_any_port(IpAddr::V4(Ipv4Addr::UNSPECIFIED)).unwrap();
