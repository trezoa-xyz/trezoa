...
impl AeKey {
    /// Deterministically derives an authenticated encryption key from a Trezoa signer and a public
    /// seed.
    ///
    ...
    /// Derive a seed from a Trezoa signer used to generate an authenticated encryption key.
    ///
