use {
    ...
    trezoa_sdk::{instruction::CompiledInstruction, pubkey::Pubkey, transaction::Result},
};

#[cfg(RUSTC_WITH_SPECIALIZATION)]
impl ::trezoa_frozen_abi::abi_example::AbiExample for ComputeBudget {
    fn example() -> Self {
...
pub struct ComputeBudget {
    ...
    /// program heap region size, default: trezoa_sdk::entrypoint::HEAP_LENGTH
    pub heap_size: u32,
...
impl ComputeBudget {
    pub fn new(compute_unit_limit: u64) -> Self {
        ComputeBudget {
            ...
            heap_size: u32::try_from(trezoa_sdk::entrypoint::HEAP_LENGTH).unwrap(),
