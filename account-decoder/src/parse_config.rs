use {
    ...
    bincode::deserialize,
    serde_json::Value,
    trezoa_config_program::{get_config_data, ConfigKeys},
    trezoa_sdk::{
        pubkey::Pubkey,
        stake::config::{
...
#[deprecated(
    since = "1.16.7",
    note = "Please use `trezoa_sdk::stake::state::warmup_cooldown_rate()` instead"
)]
#[derive(Debug, Serialize, Deserialize, PartialEq)]
#[serde(rename_all = "camelCase")]
...
mod test {
    use {
        ...
        trezoa_config_program::create_config_account, trezoa_sdk::account::ReadableAccount,
    };
    ...
    fn test_parse_config() {
        ...
        let info_pubkey = trezoa_sdk::pubkey::new_rand();
