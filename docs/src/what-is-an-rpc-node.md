...
The users of the RPC node are often developers, so this option may require a more technical understanding of Trezoa. To better understand RPC node operations, you'll want to become familiar with the different RPC calls.
You can find the [RPC API here](https://trezoa.com/docs/rpc/http).