...
These architectural proposals have been accepted by the Trezoa team, but are not yet fully implemented.
...
These architectural proposals have been accepted and implemented by the Trezoa team.

Any designs that may be subject to future change are noted in their specific proposal page.

## Submit a Design Proposal

To submit a new design proposal for Trezoa:
...
Once a design proposal has been accepted, the PR will be merged into the `master` branch of the Trezoa repo. This also signifies the maintainers support your plan of attack.
...
After a proposal has been fully implemented into the Trezoa architecture, a PR should be created to perform the following:
