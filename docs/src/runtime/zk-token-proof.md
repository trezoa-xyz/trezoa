---
title: Trezoa ZK Token Proof Program
pagination_label: Native ZK Token Proof Program
sidebar_label: ZK Token Proof Program
---

The native Trezoa ZK Token proof program verifies a number of zero-knowledge
...
for the [SPL Token 2022](https://spl.trezoa.com/token-2022) program. However,
...
- Instructions:
  [ProofInstruction](https://github.com/trezoa-team/trezoa/blob/master/zk-token-sdk/src/zk_token_proof_instruction.rs)
...
- A technical
  [overview](https://github.com/trezoa-team/trezoa-program-library/blob/master/token/zk-token-protocol-paper/part1.pdf)
...
- `VerifyPubkeyValidity`:
  ...
  - Mathematical description and proof of security:
    [[Notes]](https://github.com/trezoa-team/trezoa/blob/master/docs/src/runtime/zk-docs/pubkey_proof.pdf)
...
- `VerifyZeroBalance`:
  ...
  - The zero-balance proof certifies that an ElGamal ciphertext encrypts the
    number zero.
  - Mathematical description and proof of security:
    [[Notes]](https://github.com/trezoa-team/trezoa/blob/master/docs/src/runtime/zk-docs/zero_proof.pdf)
...
- `VerifyCiphertextCommitmentEquality`:
  ...
  - Mathematical description and proof of security:
    [[Notes]](https://github.com/trezoa-team/trezoa/blob/master/docs/src/runtime/zk-docs/ciphertext_commitment_equality.pdf)
...
- `VerifyCiphertextCiphertextEquality`:
  ...
  - Mathematical description and proof of security:
    [[Notes]](https://github.com/trezoa-team/trezoa/blob/master/docs/src/runtime/zk-docs/ciphertext_ciphertext_equality.pdf)
