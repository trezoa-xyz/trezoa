...
Trezoa contains a small handful of native programs, which are required to run
...
- Instructions: [SystemInstruction](https://docs.rs/trezoa-program/VERSION_FOR_DOCS_RS/trezoa_program/system_instruction/enum.SystemInstruction.html)
...
- Instructions: [config_instruction](https://docs.rs/trezoa-config-program/VERSION_FOR_DOCS_RS/trezoa_config_program/config_instruction/index.html)
...
- Instructions: [StakeInstruction](https://docs.rs/trezoa-sdk/VERSION_FOR_DOCS_RS/trezoa_sdk/stake/instruction/enum.StakeInstruction.html)
...
- Instructions: [VoteInstruction](https://docs.rs/trezoa-vote-program/VERSION_FOR_DOCS_RS/trezoa_vote_program/vote_instruction/enum.VoteInstruction.html)

## Address Lookup Table Program

- Program id: `AddressLookupTab1e1111111111111111111111111`
- Instructions: [AddressLookupTableInstruction](https://docs.rs/trezoa-sdk/VERSION_FOR_DOCS_RS/trezoa_sdk/address_lookup_table/instruction/enum.ProgramInstruction.html)
...
- Instructions: [LoaderInstruction](https://docs.rs/trezoa-sdk/VERSION_FOR_DOCS_RS/trezoa_sdk/loader_upgradeable_instruction/enum.UpgradeableLoaderInstruction.html)
...
instruction via a program id, the Trezoa runtime will load both your the program
...
- Instructions: [new_ed25519_instruction](https://github.com/trezoa-team/trezoa/blob/master/sdk/src/ed25519_instruction.rs#L45)
...
- Instructions: [new_secp256k1_instruction](https://github.com/trezoa-team/trezoa/blob/1a658c7f31e1e0d2d39d9efbc0e929350e2c2bcb/sdk/src/secp256k1_instruction.rs#L31)
