---
title: Setup an Trezoa-team RPC Node
sidebar_label: Setup an Trezoa-team RPC Node
sidebar_position: 6
---

Since a Trezoa RPC server runs the same process as a consensus validator, first follow the instructions on
[how to setup a Trezoa validator](./setup-a-validator.md) to get started.
