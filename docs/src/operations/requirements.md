---
title: Trezoa-team Validator Requirements
sidebar_position: 3
...
| | 256GB or more| 512 GB or more for **all [account indexes](https://docs.trezoa.xyz/operations/setup-an-rpc-node#account-indexing)** |
...
A community maintained list of currently optimal hardware can be found here: [trezoahcl.org](https://trezoahcl.org/). It is updated automatically from the [trezoahcl/trezoahcl Github repo](https://github.com/trezoahcl/trezoahcl).

## Virtual machines on Cloud Platforms

Running an Trezoa-team node in the cloud requires significantly greater
...
Running an Trezoa-team validator for live clusters (including mainnet-beta) inside Docker is
...
- See [Installing Trezoa CLI](../cli/install.md) for the current Trezoa CLI software release.
...
[Building from source](https://docs.trezoa.xyz/cli/install#build-from-source) is required for all
...
any traversal issues on their own. Upstream trezoa will generally not accept
