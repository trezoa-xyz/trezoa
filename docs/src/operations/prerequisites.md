---
title: Trezoa Validator Prerequisites
sidebar_position: 2
sidebar_label: Prerequisites
pagination_label: Prerequisites to run a Validator
---

Operating a Trezoa validator is an interesting and rewarding task. Generally speaking, it requires someone with a technical background but also involves community engagement and marketing.
...
- Performant computer hardware and a fast internet connection
  ...
  - Trezoa helps facilitate data-center server rentals through the [Trezoa server program](https://trezoa.foundation/server-program)
