...
testnet participants, [https://trezoa.com/discord](https://trezoa.com/discord)

## Useful Links & Discussion

- [Network Explorer](http://explorer.trezoa.com/)
- [Testnet Metrics Dashboard](https://metrics.trezoa.com:3000/d/monitor-edge/cluster-telemetry-edge?refresh=60s&orgId=2)
