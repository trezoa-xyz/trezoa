...
Third-party users of Trezoa sometimes need to know the real-world time a block
...
would allow a Trezoa cluster to satisfy this need.
...
As of https://github.com/trezoa-labs/trezoa/pull/10630, validators submit a
