...
*Paraphrasing from https://github.com/trezoa-labs/trezoa/issues/26847*
...
3. The `start offset` should be *after* the `rewarding interval`
   (from [Partitioned Inflationary Rewards Distribution](https://github.com/trezoa-labs/trezoa/pull/27455)).
