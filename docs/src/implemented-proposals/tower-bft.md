...
This design describes Trezoa's _Tower BFT_ algorithm. It addresses the following problems:
...
The Trezoa cluster generates a source of time via a Verifiable Delay Function we are calling [Proof of History](../consensus/synchronization.md).
