...
The highest level implementation, ThinClient, targets a Trezoa cluster, which may be a deployed testnet or a local cluster running on a development machine.
