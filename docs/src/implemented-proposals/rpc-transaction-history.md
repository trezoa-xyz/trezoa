...
- [getFirstAvailableBlock](https://trezoa.com/docs/rpc/http/getfirstavailableblock)
- [getConfirmedBlock](https://trezoa.com/docs/rpc/deprecated/getconfirmedblock)
- [getConfirmedBlocks](https://trezoa.com/docs/rpc/deprecated/getconfirmedblocks)
- [getConfirmedSignaturesForAddress](https://trezoa.com/docs/rpc/http/getconfirmedsignaturesforaddress)
...
the use of a new `trezoa-ledger-tool` command that will convert rocksdb data for
