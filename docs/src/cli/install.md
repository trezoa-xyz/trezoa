...
- [Use Trezoa's Install Tool (Simplest option)](#use-trezoas-install-tool)
- [Download Prebuilt Binaries](#download-prebuilt-binaries)
- [Build from Source](#build-from-source)
- [Use Homebrew](#use-homebrew)

## Use Trezoa's Install Tool
...
[https://github.com/trezoa-team/trezoa/releases/latest](https://github.com/trezoa-team/trezoa/releases/latest),
...
navigate to
[Trezoa's GitHub releases page](https://github.com/trezoa-team/trezoa/releases/latest),
...
[Homebrew formulae](https://github.com/Homebrew/homebrew-core/blob/HEAD/Formula/trezoa.rb)
