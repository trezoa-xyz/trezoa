---
title: Introduction to the Trezoa CLI
pagination_label: Introduction to the Trezoa CLI
sidebar_label: Introduction
sidebar_position: 2
---

Before running any Trezoa CLI commands, let's go over some conventions that
you will see across all commands. First, the Trezoa CLI is actually a collection
