---
title: Using Hardware Wallets in the Trezoa CLI
pagination_label: "Using Hardware Wallets in the Trezoa CLI"
sidebar_label: Using in the Trezoa CLI
sidebar_position: 0
---
...
The Trezoa CLI has first class support for hardware wallets. Anywhere
...
The Trezoa CLI supports the following hardware wallets:

- [Ledger Nano S and Ledger Nano X](./ledger.md)

## Specify a Keypair URL

Trezoa defines a keypair URL format to uniquely locate any Trezoa keypair on a
...
`DERVIATION_PATH` is used to navigate to Trezoa keys within your hardware wallet.
...
and that any derived keys are Trezoa keys (Coin type 501). The single quote
indicates a "hardened" derivation. Because Trezoa uses Ed25519 keypairs, all
