...
breaking API and behavior changes affecting applications and tooling built for Trezoa.
...
- Trezoa software releases include APIs, SDKs, and CLI tooling (with a few [exceptions](#exceptions)).
- Trezoa software releases follow semantic versioning, more details below.
...
New Trezoa runtime features are feature-switched and manually activated. Runtime features
...
Trezoa provides publicly available RPC API nodes for all developers to use. The Trezoa team
...
discourage dependence upon Trezoa operated nodes.
