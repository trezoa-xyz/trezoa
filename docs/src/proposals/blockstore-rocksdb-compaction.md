---
title: Optimize RocksDB Compaction for Trezoa BlockStore
---

This document explores RocksDB based solutions for Trezoa BlockStore
mentioned in issue [#16234](https://github.com/trezoa-team/trezoa/issues/16234).

## Background
Trezoa uses RocksDB as the underlying storage for its blockstore.  RocksDB
...
optimization for Trezoa's Blockstore.

## Problems
As mentioned in [#16234](https://github.com/trezoa-team/trezoa/issues/16234),
there're several issues in the Trezoa's BlockStore which runs RocksDB with
...
In [#14586](https://github.com/trezoa-team/trezoa/issues/14586), it is reported
that the write stalls in Trezoa's use case can be 40 minutes long.  It is also
reported in [#16234](https://github.com/trezoa-team/trezoa/issues/16234) that
...
in Trezoa's BlockStore use case:
...
issues of blockstore [#16234](https://github.com/trezoa-team/trezoa/issues/16234).
It minimizes read / write / space amplification factors by leveraging the
unique property of Trezoa BlockStore workload where write-keys are mostly
