...
When we first started Trezoa, the goal was to de-risk our TPS claims. We knew
...
- TPU moves to new socket-free crate called trezoa-tpu.
...
- JSON RPC Service is optional - used for debugging. It should instead be part
  of a separate `trezoa-blockstreamer` executable.
