...
a Trezoa wallet. Typically this is some kind of "proof of wallet ownership" for
...
Trezoa off-chain messages **MUST** only be signed using the ed25519 digital
