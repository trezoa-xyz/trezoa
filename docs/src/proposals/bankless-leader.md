...
The [fee account](https://trezoa.com/docs/terminology#fee_account) pays for the
...
### Check out the [SIMD here to contribute](https://github.com/trezoa-foundation/trezoa-improvement-documents/pull/5)
