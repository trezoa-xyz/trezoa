...
The Trezoa protocol doesn’t wait for all validators to agree on a newly produced
...
Trezoa validators need to vote on one of these forks and reach agreement on
...
Nodes take turns being [leader](https://trezoa.com/docs/terminology#leader) and
