...
- `node_pubkey` - The Trezoa node that votes in this account.
...
[inflation](https://trezoa.com/docs/terminology#inflation). The number of
...
[point](https://trezoa.com/docs/terminology#point).
...
[sysvar](https://trezoa.com/docs/terminology#sysvar) that maps epochs to point
values.
