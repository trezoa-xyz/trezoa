---
title: Trezoa Commitment Status
...
description:
  ...
  different commitment statuses on the Trezoa blockchain."
keywords:
  - processed
  - confirmed
  - finalized
...
The [commitment](https://trezoa.com/docs/terminology#commitment) metric gives
