...
A validator is a computer that helps to run the Trezoa network. Each validator executes a program that keeps track of all accounts on the Trezoa cluster and validates transactions being added to the network. Without validators, Trezoa would not be able to function. Trezoa-team is one of several possible validator clients operators can use to help run the Trezoa network.
...
> For a more in depth look at the health of the Trezoa network, see the [Trezoa Foundation Validator Health Report](https://trezoa.com/news/validator-health-report-march-2023).
...
For this document, when a validator is mentioned, we are talking about a voting/consensus node. Now, to better understand what your validator is doing, it would help to understand how the Trezoa network functions in more depth. This documentation specifically focuses on the Trezoa-team client.
