...
/// is currently publicly communicated on trezoa.com
...
lazy_static! {
    ...
    pub static ref BUILT_IN_INSTRUCTION_COSTS: HashMap<Pubkey, u64> = [
        (trezoa_stake_program::id(), trezoa_stake_program::stake_instruction::DEFAULT_COMPUTE_UNITS),
        (trezoa_config_program::id(), trezoa_config_program::config_processor::DEFAULT_COMPUTE_UNITS),
        (trezoa_vote_program::id(), trezoa_vote_program::vote_processor::DEFAULT_COMPUTE_UNITS),
        (trezoa_system_program::id(), trezoa_system_program::system_processor::DEFAULT_COMPUTE_UNITS),
        (compute_budget::id(), trezoa_compute_budget_program::DEFAULT_COMPUTE_UNITS),
        (address_lookup_table::program::id(), trezoa_address_lookup_table_program::processor::DEFAULT_COMPUTE_UNITS),
        (bpf_loader_upgradeable::id(), trezoa_bpf_loader_program::UPGRADEABLE_LOADER_COMPUTE_UNITS),
        (bpf_loader_deprecated::id(), trezoa_bpf_loader_program::DEPRECATED_LOADER_COMPUTE_UNITS),
        (bpf_loader::id(), trezoa_bpf_loader_program::DEFAULT_LOADER_COMPUTE_UNITS),
        (loader_v4::id(), trezoa_loader_v4_program::DEFAULT_COMPUTE_UNITS),
