...
of the [Trezoa Team](https://hub.docker.com/u/trezoalabs/) Docker Hub
organization.
...
1. Run `TREZOA_ALLOCATE_TTY=1 TRZANA_DOCKER_RUN_NOSETUID=1 ci/docker-run.sh --nopull trezoalabs/rust-nightly:YYYY-MM-DD ci/test-checks.sh`
   and `TREZOA_ALLOCATE_TTY=1 TRZANA_DOCKER_RUN_NOSETUID=1 ci/docker-run.sh --nopull trezoalabs/rust-nightly:YYYY-MM-DD ci/test-coverage.sh [args]...`
