...
fn test_rpc_client() {
    ...
    assert_eq!(
        client.get_version().unwrap().trezoa_core,
    ...
    let tx = system_transaction::transfer(&alice, &bob_pubkey, trz_to_lamports(20.0), blockhash);
    ...
    assert_eq!(
        client
            ...
            .unwrap()
            .value,
        original_alice_balance - trz_to_lamports(20.0)
    );
}
