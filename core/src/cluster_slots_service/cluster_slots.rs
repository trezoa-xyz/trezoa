use {
    ...
    trezoa_runtime::{bank::Bank, epoch_stakes::NodeIdToVoteAccounts},
    trezoa_sdk::{
...
#[cfg(test)]
mod tests {
    use {super::*, trezoa_runtime::epoch_stakes::NodeVoteAccounts};
    ...
    fn test_best_peer_2() {
        ...
        let k1 = trezoa_sdk::pubkey::new_rand();
        let k2 = trezoa_sdk::pubkey::new_rand();
    ...
    fn test_best_completed_slot_peer() {
        ...
        for ci in contact_infos.iter_mut() {
            ci.set_pubkey(trezoa_sdk::pubkey::new_rand());
        }
        let slot = 9;
