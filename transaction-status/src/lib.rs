...
pub use {crate::extract_memos::extract_and_fmt_memos, trezoa_sdk::reward_type::RewardType};
use {
    crate::{
...
pub fn map_inner_instructions(
    inner_instructions: trezoa_sdk::inner_instruction::InnerInstructionsList,
...
pub struct UiTransactionStatusMeta {
    ...
    pub status: TransactionResult<()>, // This field is deprecated.  See https://github.com/trezoa-team/trezoa/issues/9302
    pub fee: u64,
    pub pre_balances: Vec<u64>,
    pub post_balances: Vec<u64>,
    #[serde(
