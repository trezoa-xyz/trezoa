...
#[cfg(feature = "elgamal")]
use trezoa_zk_sdk::encryption::{auth_encryption::AeKey, elgamal::ElGamalKeypair};
use {
    crate::{
    ...
    trezoa_hash::Hash,
    trezoa_keypair::{read_keypair, read_keypair_file, Keypair},
    ...
    trezoa_signer::{null_signer::NullSigner, EncodableKey, EncodableKeypair, Signer},
    std::{
        cell::RefCell,
        error,
