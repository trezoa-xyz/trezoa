...
use {
    ...
    trezoa_gossip::gossip_service::discover_cluster,
    trezoa_ledger::{
...
pub const DEFAULT_CLUSTER_LAMPORTS: u64 = 10_000_000 * LAMPORTS_PER_TRZ;
...
pub fn test_faulty_node(
    ...
    let fixed_leader_schedule = custom_leader_schedule.unwrap_or_else(|| {
        ...
        let validator_to_slots = vec![(
            ...
            trezoa_sdk::clock::DEFAULT_DEV_SLOTS_PER_EPOCH as usize,
        )];
