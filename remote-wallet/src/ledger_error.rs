...
pub enum LedgerError {
    #[error("Trezoa app not open on Ledger device")]
    ...
    #[error("Ledger received invalid Trezoa message")]
    TrezoaInvalidMessage = 0x6a80,

    #[error("Ledger received message with invalid header")]
    TrezoaInvalidMessageHeader = 0x6a81,

    #[error("Ledger received message in invalid format")]
    TrezoaInvalidMessageFormat = 0x6a82,

    #[error("Ledger received message with invalid size")]
    TrezoaInvalidMessageSize = 0x6a83,

    #[error("Trezoa summary finalization failed on Ledger device")]
    TrezoaSummaryFinalizeFailed = 0x6f00,

    #[error("Trezoa summary update failed on Ledger device")]
    TrezoaSummaryUpdateFailed = 0x6f01,
