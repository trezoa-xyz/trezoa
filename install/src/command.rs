use {
    ...
    trezoa_hash::Hash,
    trezoa_keypair::{read_keypair_file, signable::Signable, Keypair},
...
fn github_release_download_url(release_semver: &str) -> String {
    format!(
        "https://github.com/trezoa-xyz/trezoa/releases/download/v{}/trezoa-release-{}.tar.bz2",
        release_semver,
...
fn release_channel_download_url(release_channel: &str) -> String {
    format!(
        "https://release.trezoa.xyz/{}/trezoa-release-{}.tar.bz2",
        release_channel,
        crate::build_env::TARGET
    )
}
...
fn release_channel_version_url(release_channel: &str) -> String {
    format!(
        "https://release.trezoa.xyz/{}/trezoa-release-{}.yml",
        release_channel,
        crate::build_env::TARGET
    )
}
...
fn check_for_newer_github_release(
    ...
    while page == 1 || releases.len() == PER_PAGE {
        let url = reqwest::Url::parse_with_params(
            "https://api.github.com/repos/trezoa-xyz/trezoa/releases",
            &[
