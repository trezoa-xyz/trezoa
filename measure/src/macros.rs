...
/// ```
/// // Measure functions
/// # use trezoa_measure::{measure_time, measure_us, meas_dur};
/// # fn foo() {}
/// # fn bar(x: i32) {}
...
/// # use trezoa_measure::measure_time;
...
/// # use trezoa_measure::{measure_time, measure_us};
/// # fn meow() {};
