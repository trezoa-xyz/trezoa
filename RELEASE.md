...
1. Fill the release notes.
   ...
   template](https://raw.githubusercontent.com/trezoa-team/trezoa/master/.github/RELEASE_TEMPLATE.md).  Engineering Lead can provide summary contents for release notes if needed.
...
* The `trezoa-secondary` Buildkite pipeline handles creating the Linux and macOS release artifacts and updated crates.  Look for a job under the tag name of the release: https://buildkite.com/trezoa-team/trezoa-secondary.
